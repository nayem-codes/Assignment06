...
const Pricing = () => {
    return (
        <div className='mt-28 flex flex-col items-center justify-center'>
            ...
            <div className="card shadow-sm mt-10 max-w-300 w-90% grid sm:grid-cols-1 md:grid-cols-3 w-full gap-7 pb-28">
  <div className="card-body bg-base-200 rounded-2xl">
    ...
    <div className="mt-6">
      <button className="btn bg-linear-to-r from-[#4F39F6] to-[#9514FA] btn-block text-white rounded-full">Get Started Free</button>
    </div>
  </div>
  <div className="card-body bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white rounded-2xl relative">
    <span className="badge badge-xs bg-yellow-200 text-yellow-700 absolute -mt-7 sm:ml-70 md:ml-22 lg:ml-33
    ">Most Popular</span>
    ...
    <div className="mt-6">
      <button className="btn bg-whit btn-block text-purple-600 rounded-full">Start Pro Trial</button>
    </div>
  </div>
  ...
  <div className="card-body bg-base-200 rounded-2xl">
    ...
    <div className="mt-6">
      <button className="btn bg-linear-to-r from-[#4F39F6] to-[#9514FA] btn-block text-white rounded-full">Contact Sales</button>
    </div>
  </div>
</div>
        </div>
